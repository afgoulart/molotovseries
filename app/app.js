(function() {
    'use strict';
    window.molotov = angular.module('Molotov', ['ngRoute', 'mongolabResourceHttp', 'ng-isotope']);
    ...
    window.molotov.controller('MolotovController', ['$scope', '$http', '$routeParams', 'Series',
        function($scope, $http, $routeParams, Series) {
            $scope.series = [];
            $scope.load = true;
            ...
            $scope.showepisode = function() {
                ...
                // $scope.serie = JSON.parse(window.localStorage[id]);
                // console.log($scope.serie);
                // if (e !== null && p !== null && k !== null) {
                //     var PLAYERS = {
                //         dp: "http://dropvideo.com/embed/{{id}}/",
                //         vdm: "http://vidto.me/embed-{{id}}.html",
                //         amv: "http://allmyvideos.net/embed-{{id}}.html"
                //     };

                //     $scope.link = PLAYERS[p].replace("{{id}}", k);
                //     $scope.episode = e;
                // } else {}
                // $scope.load = false;
            };
